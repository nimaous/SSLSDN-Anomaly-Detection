...
### Eval
```
python -m torch.distributed.launch --master_port 8993 --nproc_per_node=2 eval_checkpoints.py --train_dataset=cifar10 --pretrained_weights=/home/shared/OOD/rot_pred/rot_pred_4_classes/checkpoint.pth   --extra_tag=rotpred_exp1
